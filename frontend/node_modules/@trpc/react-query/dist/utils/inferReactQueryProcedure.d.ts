 ...
 * @internal
 */
export type InferQueryOptions<TProcedure extends AnyProcedure, TPath extends string, TData = inferTransformedProcedureOutput<TProcedure>> = Omit<UseTRPCQueryOptions<TPath, inferProcedureInput<TProcedure>, inferTransformedProcedureOutput<TProcedure>, inferTransformedProcedureOutput<TProcedure>, TRPCClientErrorLike<TProcedure>, TData>, 'select'>;
/**
 * @internal
 */
